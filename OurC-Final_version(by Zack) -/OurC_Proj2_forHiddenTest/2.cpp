...
bool Definiton_and_New_Definition( int i ) {
  ...
  if ( gIs_function_Definition ) gToken[gTemp_variable_loctation->at(i)].is_funtion_defined = true ; // 定義funtion名稱
          ...
          while ( i < gTemp_variable_loctation->size() ) {
            ...
            if ( Definiton_and_New_Definition( i ) ) {
              ...
              if ( gToken[gTemp_variable_loctation->at(i)].is_funtion_defined == true ) { 
                ...
                strcpy( gFunction_Token_info.function_name, gToken[gTemp_variable_loctation->at(i)].data ) ;
...
bool Definition() { // 定義
  ...
  printf( "------ Definition() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Type_specifier() { // 類型說明符
  printf( "------ Type_specifier() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Function_definition_or_declarators() { // 
  printf( "------ Function_definition_or_declarators() '%s', token_type '%d'\n"
          , gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_declarators() { // 變數後面有中括號 或是一次宣告很多變數 
  printf( "------ Rest_of_declarators() '%s', token_type '%d'\n"
          , gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Function_definition_without_ID() {
  ...
  printf( "------ Function_definition_without_ID() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Formal_parameter_list() { // 正式參數列表
  printf( "------ Formal_parameter_list() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Compound_statement() { // 複合陳述
  printf( "------ Compound_statement() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Declaration() {
  printf( "------ Declaration() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Statement() {
  printf( "------ Statement() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Expression() {
  ...
  printf( "------ Expression() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Basic_expression() {
  printf( "------ Basic_expression() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_Identifier_started_basic_exp() {
  printf( "------ Rest_of_Identifier_started_basic_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
  ...
  if ( gToken[gNum].token_type == M_LP || Assignment_operator() ) {
    if ( gToken[gNum].token_type == M_LP ) {
      ...
      if ( Expression() ) {
        printf( "------ Rest_of_Identifier_started_basic_exp22222() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_PPMM_Identifier_started_basic_exp() {
  printf( "------ Rest_of_PPMM_Identifier_started_basic_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Actual_parameter_list() {
  printf( "------ Actual_parameter_list() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Assignment_operator() {
  printf( "------ Assignment_operator() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Romce_and_romloe() {
  printf( "------ Romce_and_romloe() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_maybe_logical_OR_exp() {
  printf( "------ Rest_of_maybe_logical_OR_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Maybe_logical_AND_exp() {
  printf( "------ Maybe_logical_AND_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_maybe_logical_AND_exp() {
  printf( "------ Rest_of_maybe_logical_AND_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Maybe_bit_OR_exp() {
  printf( "------ Maybe_bit_OR_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_maybe_bit_OR_exp() {
  printf( "------ Rest_of_maybe_bit_OR_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Maybe_bit_ex_OR_exp() {
  printf( "------ Maybe_bit_ex_OR_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_maybe_bit_ex_OR_exp() {
  printf( "------ Rest_of_maybe_bit_ex_OR_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Maybe_bit_AND_exp() {
  printf( "------ Maybe_bit_AND_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_maybe_bit_AND_exp() {
  printf( "------ Rest_of_maybe_bit_AND_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Maybe_equality_exp() {
  printf( "------ Maybe_equality_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_maybe_equality_exp() {
  printf( "------ Rest_of_maybe_equality_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Maybe_relational_exp() {
  printf( "------ Maybe_relational_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_maybe_relational_exp() {
  printf( "------ Rest_of_maybe_relational_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Maybe_shift_exp() {
  printf( "------ Maybe_shift_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_maybe_shift_exp() {
  printf( "------ Rest_of_maybe_shift_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Maybe_additive_exp() {
  printf( "------ Maybe_additive_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_maybe_additive_exp() {
  printf( "------ Rest_of_maybe_additive_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Maybe_mult_exp() {
  printf( "------ Maybe_mult_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Rest_of_maybe_mult_exp() { // 分號會到這個funtion然後直接return回去
  printf( "------ Rest_of_maybe_mult_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Unary_exp() {
  printf( "------ Unary_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Signed_unary_exp() {
  printf( "------ Signed_unary_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
bool Unsigned_unary_exp() {
  printf( "------ Unsigned_unary_exp() '%s', token_type '%d'\n", gToken[gNum].data, gToken[gNum].token_type ) ;
...
void ListVariable( char parameter[500] ) { // 把傳進來該參數名稱 的變數 名別與名稱完整印出來
  ...
  while ( find_variable > 0 ) { // 減回去找找看有沒有定義過這個變數，因為新定義的變數會在後面
    ...
    if ( strcmp( gToken[find_variable].data, parameter ) == 0 
      ...
      while ( gToken[after_variable_name].token_type != SEMICOLON && gToken[after_variable_name].token_type != COMMA ) {
